    ...
    <PopupProvider>
      ...
      >
        ...
        <Snap>
          <Summary />
          <TechnicalSkills
            skills={Belt.Array.slice(TechnicalSkills.skillsData, ~offset=0, ~len=3)}
          />
          <TechnicalSkills
            skills={Belt.Array.slice(TechnicalSkills.skillsData, ~offset=3, ~len=6)}
          />
          {ProfessionalExperience.experienceData
          ->Belt.Array.mapWithIndex((index, data) => {
            <ProfessionalExperience
              key={`ProfessionalExperience${Belt.Int.toString(index)}`} data
            />
          })
          ->React.array}
          <FeaturedProjects
